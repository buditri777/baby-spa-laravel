...
{
    public function index() { return view('owner.akun-pasien'); }
    public function create() { return view('owner.akun-pasien-form'); }
    public function store(Request $request) { return redirect()->back()->with('success','Berhasil disimpan.'); }
    public function show($id) { return view('owner.akun-pasien'); }
    public function edit($id) { return view('owner.akun-pasien-form'); }
    ...
    public function ulasan($id = null) { return view('owner.akun-pasien'); }
}
