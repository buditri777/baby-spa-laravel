...
{
    public function index() { return view('owner.audit'); }
    public function create() { return view('owner.audit-form'); }
    public function store(Request $request) { return redirect()->back()->with('success','Berhasil disimpan.'); }
    public function show($id) { return view('owner.audit'); }
    public function edit($id) { return view('owner.audit-form'); }
    ...
    public function ulasan($id = null) { return view('owner.audit'); }
}
