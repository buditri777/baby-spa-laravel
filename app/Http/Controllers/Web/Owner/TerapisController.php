...
{
    public function index() { return view('owner.terapis'); }
    public function create() { return view('owner.terapis-form'); }
    public function store(Request $request) { return redirect()->back()->with('success','Berhasil disimpan.'); }
    public function show($id) { return view('owner.terapis'); }
    public function edit($id) { return view('owner.terapis-form'); }
    ...
    public function ulasan($id = null) { return view('owner.terapis'); }
}
