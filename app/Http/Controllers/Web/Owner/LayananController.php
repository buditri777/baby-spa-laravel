...
{
    public function index() { return view('owner.layanan'); }
    public function create() { return view('owner.layanan-form'); }
    public function store(Request $request) { return redirect()->back()->with('success','Berhasil disimpan.'); }
    public function show($id) { return view('owner.layanan'); }
    public function edit($id) { return view('owner.layanan-form'); }
    ...
    public function ulasan($id = null) { return view('owner.layanan'); }
}
