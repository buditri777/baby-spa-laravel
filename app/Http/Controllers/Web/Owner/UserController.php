...
{
    public function index() { return view('owner.users'); }
    public function create() { return view('owner.users-form'); }
    public function store(Request $request) { return redirect()->back()->with('success','Berhasil disimpan.'); }
    public function show($id) { return view('owner.users'); }
    public function edit($id) { return view('owner.users-form'); }
    ...
    public function ulasan($id = null) { return view('owner.users'); }
}
